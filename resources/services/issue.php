...
<td class="ticket-button"><a href="../team/editissue/<?= $row['id']; ?>" class="btn btn-danger">Bearbeiten</a></td><br><br>
	<?php } ?>
									...
									<tr class="tr-hover text-no-select" style="display: width: 100%;" onclick="toggleCollapse('#bar-1')">
											...
											<td style="text-align: width: 25%" id="title-2" class="">
												<center>
													<h4><i class="fa fa-stream text-danger"></i> STATUS</h4> 				
														...
														<h5 class="text-success">Behoben</h5>
														'; } ?>
														<?php if($row['Status'] == 'Offen'){ echo '
														<h5 class="text-danger">Nicht behoben</h5>
														'; } ?>
												</center>
											</td>
											...
											<td style="text-align: width: 25%" id="title-2" class="">
												<center>
													...
													<h5 class="text-white"><?= $helper->formatDate($row['created_at']); ?></h5>
												</center>
											</td>
